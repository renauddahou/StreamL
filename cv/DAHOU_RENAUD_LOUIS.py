      ...
      <div class="row">
        <div class="col-xs-12 col-sm-7">
          ...
          <div class="box">
            ...
            <p>Je dispose d’une grande ouverture d’esprit et d’une grande facilité d’adaptation.
Je jouis d’une bonne expérience professionnelle suite à l’exécution de plusieurs projets et mon domaine d’intervention s’étend aux :
• Machine Learning et Intelligence artificielle
• Web Scraping
• Cloud Computing
• Data Analysis
• Développement de API
• Test de pénétration de reseau d'entreprise</p>
<br> </br>
          </div>
          <!-- WORK EXPERIENCE -->
          <div class="box">
            <h2><i class= "fas fa-suitcase ico"></i> Expérience professionnelle</h2>
              <div class="job clearfix">
                <div class="row">
                  <div class="details">
                    ...
                    <div class="year">Janvier 2022 – Présent</div>
                  </div>
                </div>
                <div class="row">
              ...
              <div class="job clearfix">
                <div class="row">
                  <div class="details">
                    ...
                    <div class="year">Janvier 2018 – Décembre 2021</div>
                  </div>
                </div>
                <div class="row">
                  <div class="job-details col-xs-11">
                    ...
                    <div class="description">
                      ...
                      <div class="highlights"> </div>
                      <ul class="list-group">
                        <li class="list-group-item">En tant que Consultant API development & Cloud deployment , j'ai accompagné des Particuliers ; Etudiants et Entreprises dans la réalisation de projet data driven et Machine learning:</li>
                        <li class="list-group-item">• Application du process ETL (Extract-Transform-Load) pour l'analyse de marché crypto-monnaie</li>
                        <li class="list-group-item">• Developpement d'API Scoring en python  pour matcher un profile candidat par rapport à un job </li>
                        <li class="list-group-item">• Développement d'une application pour l'analyse de planning pour identifier les heures creuses des étudiants au sein d'un campus pour la programmation d'activité à forte participation</li>
                        <li class="list-group-item">• Développemnt d'une application data record et analysis dans le domains de la sécurité au travail</li>
                        <li class="list-group-item">• Developpemnt d'un bot télegram pour la commande de fastfood</li>
          ...
          <div class="box">
            ...
            <ul class="list-group">
              <a href="https://renaud17.github.io/mesprojets/EDA_funnel_marketing_B2B.html" target= "_blank"><i class="fas fa-globe ico"> Analyse exploratoire des données d'
un funnel marketing B2B en utilisant Python</i></a>
              <li class="list-group-item">Ce projet se concentre sur la réalisation D'une analyse exploratoire des données (EDA) pour le Marketing B2B en utilisant Python. 
              Nous utiliserons les données D'Olist, une plate-forme de commerce électronique qui relie les petites et moyennes entreprises aux principaux marchés du Brésil, 
              par exemple. En plus de fournir la méthode et le code, je veux également discuter des principes fondamentaux du Marketing B2B et de la façon dont ces idées EDA 
              peuvent aider Olist à prendre une meilleure décision marketing.
              </li>
...
prédiction du CLV</i></a>
              <li class="list-group-item">Ce projet se concentre sur la réalisation D'une segementation et la prediction de la valeur à vie du client ;des jours d'achats future et la prevision des vente pour le Marketing B2C en utilisant Python. Nous utiliserons les données d'un détaillant en ligne basée au Royaume-Uni pendant une période de huit mois. En plus de fournir la méthode et le code, je veux également discuter des principes fondamentaux du Marketing B2C et de la façon dont ces idées EDA peuvent aider à prendre une meilleure décision marketing.
              </li>
              ...
              <li class="list-group-item">Ce projet se concentre sur la réalisation d'une application avec base de données SQL ayant les fonctionnalités suivantes : 
 
 √ Ajouter, afficher, modifier, supprimer et télécharger des données 
  
 √ Interface de travail personnel à chaque utilisateur(login) 
  
 √ Gestion KPI-HSE de plusieurs chantiers et suivi graphique..
              </li>
              <a href="https://renauddahou-streaml-p2app-y7zbjh.streamlitapp.com" target= "_blank"><i class="fas fa-globe ico"> Application pour l'exploration automatique des données</i></a>
              <li class="list-group-item">Ce projet se concentre sur la réalisation D'une analyse exploratoire des données (EDA) de façon automatique.
              </li>
            </ul>
          </div>
        </div>
        <div class="col-xs-12 col-sm-5">
          ...
          <div class="box">
            ...
            <ul id="education" class="clearfix">
              <li>
                <div class="year pull-left">2022 - Présent</div>
                <div class="description pull-right">
                  <h3>MIT Sloan School of Management</h3>
                  <div class="where"></div>
                  <p><i class= "fas fa-graduation-cap ico"></i> Machine Learning in Business</p>
                  <p>Incorporer l'apprentissage automatique dans votre stratégie d'entreprise, en explorant la valeur et l'impact de cette technologie</p>
                </div>
              </li>
              <li>
                ...
                <div class="description pull-right">
                  ...
                  <p>Pentesting</p>
                    <div>Cours à distance</div>
                    <ul class="list-group">
                      <li class="list-group-item">Hacking Base professionnel</li>
                      <li class="list-group-item">Hacking Distant</li>
                      <li class="list-group-item">Administration et Sécurité des serveurs d'entreprise</li>
                    </ul>
                </div>
              </li>
              <li>
                ...
                <div class="description pull-right">
                  ...
                  <p>Data Science</p>
                    ...
                    <ul class="list-group">
                      ...
                      <li class="list-group-item">Analyse de données textuelles</li>
                      <li class="list-group-item">Conception des architectures Big Data</li>
                      <li class="list-group-item">Réalisation des calculs distribués sur des données massives</li>
                      <li class="list-group-item">Évaluation et amélioration des performances d'un modèle de machine learning</li>
                      <li class="list-group-item">Entraînement d'un modèle prédictif linéaire</li>
                      <li class="list-group-item">Exploration de données avec des algorithmes non supervisés</li>
                      <li class="list-group-item">Utilisation des modèles supervisés non linéaires</li>
                    </ul>
                </div>
              </li>
              <li>
          ...
          <!-- SKILLS -->
          <div class="box">
            <h2><i class="fas fa-tasks ico"></i> Compétences</h2>
            <div class="skills clearfix">
              <div class="item-skills">
                  Languages-Packages-Services
                  <span class="skill-level">Expérimenté</span>
              </div>
          ...
          <!-- HOBBIES -->
          <div class="box">
            <h2><i class="fas fa-heart ico"></i> Intérêts</h2>
            <div class="interests clearfix">
              ...
              <div class="col-sm-offset-1 col-sm-12 clearfix">
                ...
                <span class= "interest badge">Cyber Sécurité</span>
              </div>
            </div>
            <div class="box">
            <h2><i class= "fas fa-check-square ico"></i> References</h2>
            
              <div>Josué AFOUDA</div>
              <div class="contact-item">
              <div class="icon pull-left text-center"><span class="fab fa-linkedin fa-fw"></span></div>
              <div class="title pull-right">Consultant Data Science</div>
              <div class="description pull-right"><a href="https://www.linkedin.com/in/josu%C3%A9-a-741693217/" target="_blank">josué-a-741693217</a></div>
              <br> </br>
              <br> </br>
              <div>Olivier Moulengue </div>
              <div class="contact-item">
              <div class="icon pull-left text-center"><span class="fab fa-linkedin fa-fw"></span></div>
              <div class="title pull-right">Responsable pôle Architecture IT HEC Paris</div>
              <br> </br>
